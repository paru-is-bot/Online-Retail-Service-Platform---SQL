...
('Home Appliances', 'Everyday household appliances'),
('Sports & Fitness', 'Gear and equipment for fitness and sports');
...
('Microwave Oven', 4, 159.99, 40),
('Refrigerator', 4, 899.99, 20),
('Washing Machine', 4, 499.99, 25),
('Treadmill', 5, 699.99, 15),
('Yoga Mat', 5, 24.99, 100),
('Dumbbell Set (20kg)', 5, 119.99, 50);
...
('Rahul', 'Sharma', 'rahul.sharma@example.com', '456-123-7890', '221 Baker St.', 'Delhi', 'DL', '110001', 'India'),
('Emily', 'Johnson', 'emily.j@example.com', '789-321-6540', '22 Maple Ave.', 'Chicago', 'IL', '60616', 'USA'),
('Arjun', 'Mehta', 'arjun.mehta@example.com', '654-987-1230', '55 MG Road', 'Pune', 'MH', '411001', 'India'),
('Laura', 'Brown', 'laura.brown@example.com', '890-456-1234', '12 Pine St.', 'Boston', 'MA', '02115', 'USA');
...
INSERT INTO Orders(CustomerId, OrderDate, TotalAmount) VALUES (1, GETDATE(), 719.98);
INSERT INTO Orders(CustomerId, OrderDate, TotalAmount) VALUES (2, GETDATE(), 49.99);
INSERT INTO Orders(CustomerId, OrderDate, TotalAmount) VALUES (3, GETDATE(), 44.98);

INSERT INTO OrderItems(OrderID, ProductID, Quantity, Price) VALUES (1, 1, 1, 699.99);
INSERT INTO OrderItems(OrderID, ProductID, Quantity, Price) VALUES (1, 3, 1, 19.99);
INSERT INTO OrderItems(OrderID, ProductID, Quantity, Price) VALUES (2, 4, 1, 49.99);
INSERT INTO OrderItems(OrderID, ProductID, Quantity, Price) VALUES (3, 5, 1, 14.99);
INSERT INTO OrderItems(OrderID, ProductID, Quantity, Price) VALUES (3, 6, 1, 29.99);

-- Expanded 20+ orders
INSERT INTO Orders (CustomerId, OrderDate, TotalAmount)
VALUES
(1, GETDATE(), 999.99),   -- Laptop
(1, GETDATE(), 29.98),    -- 2 T-shirts
(2, GETDATE(), 49.99),    -- Jeans
(2, GETDATE(), 14.99),    -- Novel
(3, GETDATE(), 29.99),    -- Science Journal
(3, GETDATE(), 719.98),   -- Smartphone + T-shirt
(1, GETDATE(), 159.99),   -- Microwave
(2, GETDATE(), 24.99),    -- Yoga Mat
(3, GETDATE(), 119.99),   -- Dumbbells
(4, GETDATE(), 699.99),   -- Smartphone
(5, GETDATE(), 19.99),    -- T-shirt
(6, GETDATE(), 64.98),    -- 2 Novels + Journal
(7, GETDATE(), 49.99),    -- Jeans
(4, GETDATE(), 499.99),   -- Washing Machine
(5, GETDATE(), 724.98),   -- Treadmill + Yoga Mat
(6, GETDATE(), 899.99),   -- Refrigerator
(7, GETDATE(), 144.98),   -- Dumbbell + Yoga Mat
(5, GETDATE(), 24.99),    -- Yoga Mat again
(6, GETDATE(), 159.99);   -- Microwave again

-- Expanded OrderItems (OrderID continues sequentially)
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (4, 2, 1, 999.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (5, 3, 2, 29.98);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (6, 4, 1, 49.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (7, 5, 1, 14.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (8, 6, 1, 29.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (9, 1, 1, 699.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (9, 3, 1, 19.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (10, 7, 1, 159.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (11, 11, 1, 24.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (12, 12, 1, 119.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (13, 1, 1, 699.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (14, 3, 1, 19.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (15, 5, 2, 29.98);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (15, 6, 1, 29.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (16, 4, 1, 49.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (17, 9, 1, 499.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (18, 10, 1, 699.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (18, 11, 1, 24.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (19, 8, 1, 899.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (20, 12, 1, 119.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (20, 11, 1, 24.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (21, 11, 1, 24.99);
INSERT INTO OrderItems (OrderID, ProductID, Quantity, Price) VALUES (22, 7, 1, 159.99);
